...
({ __u64 type_size = (__u64) type << 32; type_size |= type == KVM_X86_REG_TYPE_MSR ? KVM_REG_SIZE_U64 : type == KVM_X86_REG_TYPE_KVM ? KVM_X86_KVM_REG_SIZE(reg) : 0; type_size; \
})
#define KVM_X86_REG_ID(type,index) (KVM_REG_X86 | KVM_X86_REG_TYPE_SIZE(type, index) | index)
#define KVM_X86_REG_MSR(index) KVM_X86_REG_ID(KVM_X86_REG_TYPE_MSR, index)
#define KVM_X86_REG_KVM(index) KVM_X86_REG_ID(KVM_X86_REG_TYPE_KVM, index)
